...
the length of the burn-in (or warm-up). Still yet it is important to monitor convergence. See [here](https://mc-stan.org/learn-stan/diagnostics-warnings.html) for an introduction to MCMC diagnostics.
...
I am not sure there are general guidelines, but typically we do not want "auto correlation...for higher values of k, [because] this indicates a high degree of correlation between our samples and slow mixing " [source](https://mc-stan.org/learn-stan/diagnostics-warnings.html)
