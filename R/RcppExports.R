...
Theta_continuous <- function(Y, iter, delta, epsilon, prior_only, explore, start, progress, impute, Y_missing, store) {
    .Call(`_BGGM_Theta_continuous`, Y, iter, delta, epsilon, prior_only, explore, start, progress, impute, Y_missing, store)
}
...
mv_continuous <- function(Y, X, delta, epsilon, iter, start, progress, store) {
    .Call(`_BGGM_mv_continuous`, Y, X, delta, epsilon, iter, start, progress, store)
}

mv_binary <- function(Y, X, delta, epsilon, iter, beta_prior, cutpoints, start, progress, store) {
    .Call(`_BGGM_mv_binary`, Y, X, delta, epsilon, iter, beta_prior, cutpoints, start, progress, store)
}

mv_ordinal_albert <- function(Y, X, iter, delta, epsilon, K, start, progress, store) {
    .Call(`_BGGM_mv_ordinal_albert`, Y, X, iter, delta, epsilon, K, start, progress, store)
}

copula <- function(z0_start, levels, K, Sigma_start, iter, delta, epsilon, idx, progress, store) {
    .Call(`_BGGM_copula`, z0_start, levels, K, Sigma_start, iter, delta, epsilon, idx, progress, store)
}
...
missing_copula <- function(Y, Y_missing, z0_start, Sigma_start, levels, iter_missing, progress_impute, K, idx, epsilon, delta, store) {
    .Call(`_BGGM_missing_copula`, Y, Y_missing, z0_start, Sigma_start, levels, iter_missing, progress_impute, K, idx, epsilon, delta, store)
}
