...
// Theta_continuous
Rcpp::List Theta_continuous(arma::mat Y, int iter, float delta, float epsilon, int prior_only, int explore, arma::mat start, bool progress, bool impute, arma::mat Y_missing, bool store, int burnin, int thin, bool store_burnin);
RcppExport SEXP _BGGM_Theta_continuous(SEXP YSEXP, SEXP iterSEXP, SEXP deltaSEXP, SEXP epsilonSEXP, SEXP prior_onlySEXP, SEXP exploreSEXP, SEXP startSEXP, SEXP progressSEXP, SEXP imputeSEXP, SEXP Y_missingSEXP, SEXP storeSEXP, SEXP burninSEXP, SEXP thinSEXP, SEXP store_burninSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< bool >::type store_burnin(store_burninSEXP);
    rcpp_result_gen = Rcpp::wrap(Theta_continuous(Y, iter, delta, epsilon, prior_only, explore, start, progress, impute, Y_missing, store, burnin, thin, store_burnin));
    return rcpp_result_gen;
END_RCPP
}
// sample_prior
...
// mv_continuous
Rcpp::List mv_continuous(arma::mat Y, arma::mat X, float delta, float epsilon, int iter, arma::mat start, bool progress, bool store, int burnin, int thin, bool store_burnin);
RcppExport SEXP _BGGM_mv_continuous(SEXP YSEXP, SEXP XSEXP, SEXP deltaSEXP, SEXP epsilonSEXP, SEXP iterSEXP, SEXP startSEXP, SEXP progressSEXP, SEXP storeSEXP, SEXP burninSEXP, SEXP thinSEXP, SEXP store_burninSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type thin(thinSEXP);
    Rcpp::traits::input_parameter< bool >::type store_burnin(store_burninSEXP);
    rcpp_result_gen = Rcpp::wrap(mv_continuous(Y, X, delta, epsilon, iter, start, progress, store, burnin, thin, store_burnin));
    return rcpp_result_gen;
END_RCPP
}
// mv_binary
Rcpp::List mv_binary(arma::mat Y, arma::mat X, float delta, float epsilon, int iter, float beta_prior, arma::rowvec cutpoints, arma::mat start, bool progress, bool store, int burnin, int thin, bool store_burnin);
RcppExport SEXP _BGGM_mv_binary(SEXP YSEXP, SEXP XSEXP, SEXP deltaSEXP, SEXP epsilonSEXP, SEXP iterSEXP, SEXP beta_priorSEXP, SEXP cutpointsSEXP, SEXP startSEXP, SEXP progressSEXP, SEXP storeSEXP, SEXP burninSEXP, SEXP thinSEXP, SEXP store_burninSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type thin(thinSEXP);
    Rcpp::traits::input_parameter< bool >::type store_burnin(store_burninSEXP);
    rcpp_result_gen = Rcpp::wrap(mv_binary(Y, X, delta, epsilon, iter, beta_prior, cutpoints, start, progress, store, burnin, thin, store_burnin));
    return rcpp_result_gen;
END_RCPP
}
// mv_ordinal_albert
Rcpp::List mv_ordinal_albert(arma::mat Y, arma::mat X, int iter, float delta, float epsilon, int K, arma::mat start, bool progress, bool store, int burnin, int thin, bool store_burnin);
RcppExport SEXP _BGGM_mv_ordinal_albert(SEXP YSEXP, SEXP XSEXP, SEXP iterSEXP, SEXP deltaSEXP, SEXP epsilonSEXP, SEXP KSEXP, SEXP startSEXP, SEXP progressSEXP, SEXP storeSEXP, SEXP burninSEXP, SEXP thinSEXP, SEXP store_burninSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type thin(thinSEXP);
    Rcpp::traits::input_parameter< bool >::type store_burnin(store_burninSEXP);
    rcpp_result_gen = Rcpp::wrap(mv_ordinal_albert(Y, X, iter, delta, epsilon, K, start, progress, store, burnin, thin, store_burnin));
    return rcpp_result_gen;
END_RCPP
}
// copula
Rcpp::List copula(arma::mat z0_start, arma::mat levels, arma::vec K, arma::mat Sigma_start, int iter, float delta, float epsilon, arma::vec idx, bool progress, bool store, int burnin, int thin, bool store_burnin);
RcppExport SEXP _BGGM_copula(SEXP z0_startSEXP, SEXP levelsSEXP, SEXP KSEXP, SEXP Sigma_startSEXP, SEXP iterSEXP, SEXP deltaSEXP, SEXP epsilonSEXP, SEXP idxSEXP, SEXP progressSEXP, SEXP storeSEXP, SEXP burninSEXP, SEXP thinSEXP, SEXP store_burninSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    Rcpp::traits::input_parameter< int >::type thin(thinSEXP);
    Rcpp::traits::input_parameter< bool >::type store_burnin(store_burninSEXP);
    rcpp_result_gen = Rcpp::wrap(copula(z0_start, levels, K, Sigma_start, iter, delta, epsilon, idx, progress, store, burnin, thin, store_burnin));
    return rcpp_result_gen;
END_RCPP
}
...
// missing_copula
Rcpp::List missing_copula(arma::mat Y, arma::mat Y_missing, arma::mat z0_start, arma::mat Sigma_start, arma::mat levels, int iter_missing, bool progress_impute, arma::vec K, arma::vec idx, float epsilon, float delta, bool store, int burnin, int thin, bool store_burnin);
RcppExport SEXP _BGGM_missing_copula(SEXP YSEXP, SEXP Y_missingSEXP, SEXP z0_startSEXP, SEXP Sigma_startSEXP, SEXP levelsSEXP, SEXP iter_missingSEXP, SEXP progress_imputeSEXP, SEXP KSEXP, SEXP idxSEXP, SEXP epsilonSEXP, SEXP deltaSEXP, SEXP storeSEXP, SEXP burninSEXP, SEXP thinSEXP, SEXP store_burninSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< arma::mat >::type Y(YSEXP);
    ...
    Rcpp::traits::input_parameter< int >::type thin(thinSEXP);
    Rcpp::traits::input_parameter< bool >::type store_burnin(store_burninSEXP);
    rcpp_result_gen = Rcpp::wrap(missing_copula(Y, Y_missing, z0_start, Sigma_start, levels, iter_missing, progress_impute, K, idx, epsilon, delta, store, burnin, thin, store_burnin));
    return rcpp_result_gen;
END_RCPP
}
// missing_copula_data
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_BGGM_Theta_continuous", (DL_FUNC) &_BGGM_Theta_continuous, 14},
    {"_BGGM_sample_prior", (DL_FUNC) &_BGGM_sample_prior, 7},
    {"_BGGM_mv_continuous", (DL_FUNC) &_BGGM_mv_continuous, 11},
    {"_BGGM_mv_binary", (DL_FUNC) &_BGGM_mv_binary, 13},
    {"_BGGM_mv_ordinal_albert", (DL_FUNC) &_BGGM_mv_ordinal_albert, 12},
    {"_BGGM_copula", (DL_FUNC) &_BGGM_copula, 13},
    ...
    {"_BGGM_missing_copula", (DL_FUNC) &_BGGM_missing_copula, 15},
